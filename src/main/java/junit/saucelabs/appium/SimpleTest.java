package junit.saucelabs.appium;
...
public class SimpleTest {
    ...
    public void setUp() throws Exception {
        // set up appium
        File appDir = new File(System.getProperty("user.dir"), "/src/apps/TestApp/build/release-iphonesimulator");
        ...
        System.out.println("** App is initialised **");
    }
